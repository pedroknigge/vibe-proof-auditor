...
Pre-1.0 (`0.9.3`). A good adversarial agent skill with a deterministic validator. Not a production certification.
...
│   └── fixtures/skill-docs/      # demo-skill 0.9.3; native AGY, intentionally testless
├── tests/
